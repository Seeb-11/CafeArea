...
class HomeScreen extends StatelessWidget {
  ...
  HomeScreen({super.key,   required this.displayName, required this.photoURL});
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                             ...
                             const Text("Delivers To",style: TextStyle(color:Colors.white,fontSize: 12,fontWeight: FontWeight.w400),),
                              // Text(,style: TextStyle(color:Colors.white,fontSize: 16,fontWeight: FontWeight.w600)),
                              CafeTextTheme().text(text: displayName!, tStyle: CafeTextTheme().smallSubTittleText())
